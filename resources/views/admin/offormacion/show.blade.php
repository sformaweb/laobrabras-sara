<x-app-layout>
    ...
    <div class="py-2">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-0 pt-4">
                    <h2 class="inline-block text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight dark:text-slate-200 py-4 pl-6 block sm:inline-block flex">{{ __('Oferta formación') }}</h2>
 ...
 <abbr class="tooltip tooltip--right" data-tooltip="&nbsp; Volver">
                            ...
                            {{--__('<< Back to all offormacion') --}}</abbr>
</a>
                    @if ($errors->any())
