                    ...
                    <form method="POST" action="{{ route('empresa.store') }}">
                        ...
                        <div class="py-2">
                            ...
                            <input id="localidade"
                                ...
                                type="text" name="localidade" value="{{ old('localidade') }}" />
                        </div>
                        {{-- <div class="py-2">
                            <label for="poboacion"
                        ...
                        <div class="py-2">
                            ...
                            <input id="actividade"
                                ...
                                type="text" name="actividade" value="{{ old('actividade') }}" />
                        </div>
                        <div class="py-2">
                            <label for="tfnofijo"
                                class="block font-medium text-sm text-gray-700{{ $errors->has('tfnofijo') ? ' text-red-400' : '' }}">{{ __('Teléfono fixo') }}</label>
                            <input id="tfnofijo"
                                class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full{{ $errors->has('tfnofijo') ? ' border-red-400' : '' }}"
                                type="text" name="tfnofijo" value="{{ old('telefono') }}" />
                        </div>
                        <div class="py-2">
                            <label for="persoa_contacto"
                                class="block font-medium text-sm text-gray-700{{ $errors->has('persoa_contacto') ? ' text-red-400' : '' }}">{{ __('persoa_contacto') }}</label>
                        ...
                        <div class="py-2">
                            <label for="ofertas_contratacion"
                                class="block font-medium text-sm text-gray-700{{ $errors->has('ofertas_contratacion') ? ' text-red-400' : '' }}">{{ __('ofertas_contratacion') }}</label>
                        ...
                        <div class="py-2">
                            <label for="ofertas_formacion"
                                class="block font-medium text-sm text-gray-700{{ $errors->has('ofertas_formacion') ? ' text-red-400' : '' }}">{{ __('ofertas_formacion') }}</label>
